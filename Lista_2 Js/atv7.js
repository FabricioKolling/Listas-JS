...
desperdicio = Number(prompt('Digite a quantidade de chopp (litros) desperdiçados:'))
sobrou = Number(prompt('Digite a quantidade de chopp (litros) que sobrou:'))

litrosRestantes = (litrosChopp - (desperdicio + sobrou))
media = (litrosRestantes / pessoas)

alert('Aqui está a media de litros bebidos por pessoa na festa: \n'+ Math.round(media) +' litros')
